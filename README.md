...
CLI tool that captures a bug report from a connected iOS device in one shot — screen recording, screenshot, app sandbox files, filtered logs, crash logs, and a structured JSON report.
